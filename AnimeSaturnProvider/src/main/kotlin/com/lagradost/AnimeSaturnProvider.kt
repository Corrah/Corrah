...
class AnimeSaturnProvider : MainAPI() {
    override var mainUrl = "https://www.animesaturn.bz"
    ...
    override suspend fun loadLinks(
        ...
        callback.invoke(
            ExtractorLink(
                ...
                episodeUrl!!,
                isM3u8 = isM3U8,
                referer = "https://www.animesaturn.co/", //Some servers need the old host as referer, and the new ones accept it too
