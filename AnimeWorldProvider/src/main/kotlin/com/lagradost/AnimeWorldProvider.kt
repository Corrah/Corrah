...
//                , cookies = cookies
        ...
        private suspend fun getCookies(url: String): Map<String, String> {
            ...
            val slowAes = app.get("https://www.animeworld.so/aes.min.js").text
//            val slowAes = """
...
//            """.trimIndent()
    ...
    override suspend fun quickSearch(query: String): List<SearchResponse>? {
        val document = app.post("https://www.animeworld.so/api/search/v2?keyword=${query}", referer = mainUrl, cookies = cookies, headers = mapOf("csrf-token" to token)).text
